...
@Service
public class PlannifedInvestEmailService {

    @Autowired
    private TemplateEngine templateEngine;
    private final SesClient sesClient;

    public PlannifedInvestEmailService() {
        this.sesClient = SesClient.builder().build();
    }

    public void sendEmail(String to, String subject, Map<String, Object> templateModel, String emailTemplate) {
